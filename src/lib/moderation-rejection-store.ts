...
function resolveQuoteDbBinding(env: Record<string, unknown>): D1Binding | null {
  return ((env.QUOTE_DB ?? env.TINA_DB ?? null) as D1Binding | null) || null
}

export async function persistModerationRejectionAttempt(attempt: ModerationRejectionAttempt): Promise<void> {
