...
| `/api/v1/client/txt2embedding` | `Bge_M3_INT8`                                                             | 10  | 500 |
...
| `/api/v1/client/txt2embedding` | `Bge_M3_INT8`                                                              | 300 | Unlimited |
...
These limits are returned dynamically via the [Models endpoint](/docs/v1/api/utilities/model-selection):
