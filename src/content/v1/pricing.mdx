...
Monthly subscription tiers bundle API credits with tiered discounts on additional top-ups.
**1 credit = $1 USD of API usage.** Included subscription credits reset on the first of every calendar month — unused subscription credits do not carry over.

Included credits per month match the plan price:
Starter `50`, Growth `250`, Scale `1000`.

<SaasSubscriptionPricingTables />

<Callout>
**Monthly credit reset:** Included subscription credits reset at the end of each calendar month (UTC). Unused subscription credits do not roll over. Separately purchased top-up credits have no expiry.
</Callout>

See the live [pricing page](/pricing) for an interactive monthly/annual toggle and subscribe links.
