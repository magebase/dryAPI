...
| ------------------------------------------------------------------------------- | -------------------------- | ------------------------------ |
| [Image Prompt Booster](/docs/v1/api/prompt-enhancement/image-prompt-booster)            | `POST /prompt/image`       | Text-to-image generation       |
...
| [Speech Prompt Booster](/docs/v1/api/prompt-enhancement/speech-prompt-booster)          | `POST /prompt/speech`      | Text-to-speech synthesis       |
| [Image-to-Image Booster](/docs/v1/api/prompt-enhancement/image-to-image-prompt-booster) | `POST /prompt/image2image` | Image transformation           |
| [Sample Prompts](/docs/v1/api/prompt-enhancement/sample-prompts)                        | `GET /prompts/samples`     | Generate creative ideas        |
