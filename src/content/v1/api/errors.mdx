...
**Solution:** Verify the resource identifier (`request_id`, model name) is correct. Use the [Model Selection](/docs/v1/api/utilities/model-selection) endpoint to get valid model names.
