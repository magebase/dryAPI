...
This guide explains how to integrate deAPI with a **self-hosted n8n instance** using the official deAPI community node. The community node provides a simpler, no-code experience compared to the [HTTP Request-based approach](/docs/v1/execution-modes-and-integrations/n8n-integration).
...
* A **deAPI API key** from the [deAPI Dashboard](/docs/v1/quickstart#2-obtain-your-api-key)
...
| ------------------ | --------------------------------------- | -------------------------------------------------------------------------------- |
| **API Key**        | Your deAPI API key for authentication   | [deAPI Quickstart Guide](/docs/v1/quickstart#2-obtain-your-api-key) |
