      ...
      <div className="relative border-b border-white/10">
        ...
        >
          ...
          <div className="grid w-full gap-2 sm:w-auto sm:grid-cols-2">
            <QuoteAwareLink
              className="inline-flex w-full items-center justify-center rounded-sm border border-primary/40 bg-gradient-to-r from-primary via-accent to-[color:var(--cta-cool-b)] px-4 py-2 text-xs font-semibold uppercase tracking-[0.15em] text-primary-foreground shadow-lg transition hover:brightness-110"
