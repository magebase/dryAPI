...
import { DEFAULT_LOCALE, isSupportedLocale, SUPPORTED_LOCALES } from "@/lib/i18n"

export const dynamic = "force-static"

export function generateStaticParams() {
  return getLocalizedDocsStaticParams(SUPPORTED_LOCALES.filter((locale) => locale !== DEFAULT_LOCALE))
}
