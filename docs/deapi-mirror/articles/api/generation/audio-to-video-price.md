...
````yaml openapi.json post /api/v1/client/aud2video/price-calculation
openapi: 3.0.0
info:
...
paths:
  /api/v1/client/aud2video/price-calculation:
    post:
      tags:
        - Client API
      description: Endpoint for calculating price for audio2video inference
      operationId: requestAud2VideoPrice
      parameters:
        - $ref: '#/components/parameters/AcceptHeader'
      requestBody:
        description: Audio to video price calculation parameters
        required: true
        content:
          application/json:
            schema:
      ...
      responses:
        '200':
          description: Calculated price for audio2video inference.
          content:
            application/json:
              schema:
                properties:
