...
````yaml openapi.json post /api/v1/client/txt2video/price-calculation
openapi: 3.0.0
info:
...
paths:
  /api/v1/client/txt2video/price-calculation:
    post:
      tags:
        - Client API
      description: Endpoint for calculating price for text2video inference
      operationId: requestTxt2VideoPrice
      parameters:
      ...
      responses:
        '200':
          description: Calculated price for txt2video inference.
          content:
            application/json:
              schema:
                properties:
