...
````yaml openapi.json post /api/v1/client/txt2embedding/price-calculation
openapi: 3.0.0
info:
...
paths:
  /api/v1/client/txt2embedding/price-calculation:
    post:
      tags:
        - Client API
      description: Endpoint for calculating price for text to embedding inference
      operationId: requestPriceForTxt2Embedding
      parameters:
      ...
      responses:
        '200':
          description: Calculated price for txt2embedding inference.
          content:
            application/json:
              schema:
                properties:
