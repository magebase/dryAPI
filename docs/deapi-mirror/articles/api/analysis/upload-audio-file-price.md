...
````yaml openapi.json post /api/v1/client/audiofile2txt/price-calculation
openapi: 3.0.0
info:
...
paths:
  /api/v1/client/audiofile2txt/price-calculation:
    post:
      tags:
        - Client API
      description: Endpoint for requesting audio transcription price
      operationId: requestAudioFilePrice2Txt
      parameters:
              ...
              oneOf:
                - required:
                  ...
                  properties:
                    audio:
                      description: >-
                        Audio file to transcribe. Supported formats: AAC, MP3,
                        OGG, WAV, WebM, FLAC. Maximum file size: 10 MB.
                      type: string
                      format: binary
                    include_ts:
                ...
                - required:
                  ...
                  properties:
                    duration_seconds:
                      description: Duration of audio in seconds for price calculation
                      type: integer
                      example: 120
                    include_ts:
                      description: Should transcription include timestamps
