...
````yaml openapi.json post /api/v1/client/videofile2txt/price-calculation
openapi: 3.0.0
info:
              ...
              oneOf:
                - required:
                  ...
                  properties:
                    video:
                      description: >-
                        Video file to transcribe. Supported formats: MP4, MPEG,
                        QuickTime (MOV), AVI, WMV, OGG. Maximum file size: 10
                        MB. Video must contain an audio stream.
                      type: string
                      format: binary
                    include_ts:
