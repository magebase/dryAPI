...
> Endpoint for requesting image background removal inference
...
````yaml openapi.json post /api/v1/client/img-rmbg
openapi: 3.0.0
info:
...
paths:
  /api/v1/client/img-rmbg:
    post:
      tags:
        - Client API
      description: Endpoint for requesting image background removal inference
      operationId: requestImgRemoveBg
      parameters:
              ...
              properties:
                image:
                  description: >-
                    ...
                    JPG, JPEG, PNG, GIF, BMP, WebP. Maximum file size: 10 MB.
                  type: string
                  format: binary
                model:
