...
paths:
  /api/v1/client/img2img/price-calculation:
    post:
      tags:
        - Client API
      description: Endpoint for calculating price for img2img inference
      operationId: requestPriceForImage2Image
      parameters:
      ...
      responses:
        '200':
          description: Calculated price for img2img inference.
          content:
            application/json:
              schema:
                properties:
