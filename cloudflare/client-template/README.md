...
1. AI chatbot: `$99 / month`
1. Extra pages: `$29 / month per page`
1. Internationalization: `$49 / month per language`
1. Manual blog: `$59 / month`
1. Automatic blog (Gemini daily posts): `$119 / month` (model default: `gemini-3-flash`)
1. Extra seats: `$29 / month per seat`
1. Retainer: `$99 / hour`
