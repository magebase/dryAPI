...
function parseArgs(argv) {
  ...
  if (!options.brand) {
    throw new Error("Missing --brand. Example: node scripts/scaffold-brand-instance.mjs --brand embedapi")
  }
    ...
    JSON.stringify(
      {
        ...
        nextSteps: [
          ...
          `node scripts/generate-model-keyword-pages.mjs --brand ${options.brand} --dry-run --max-new-posts 3`,
        ],
        referenceDefaults: {
