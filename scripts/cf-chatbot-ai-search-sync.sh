...
Supported aliases are accepted for compatibility:
  ...
  CLOUDFLARE_AI_SEARCH_MANAGER_TOKEN, CLOUDFLARE_AI_SEARCH_MANAGER_TOKEN_ID,
  CLOUDFLARE_AI_SEARCH_TOKEN, CLOUDFLARE_AI_SEARCH_TOKEN_ID -> API token
...
api_token="$(first_non_empty_value \
  ...
  CLOUDFLARE_AI_SEARCH_TOKEN_ID || true)"
